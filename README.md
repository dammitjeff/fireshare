...
GPU transcoding is **optional** but provides 5-10x faster encoding if you have an NVIDIA GPU. CPU transcoding works fine without any of this setup.
...
1. AV1 with CPU - best compression, slower
2. H.264 with CPU - fallback if AV1 fails
